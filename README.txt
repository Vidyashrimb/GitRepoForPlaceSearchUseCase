...
Once the Docker Image of the project is down-loaded from the Git, we can see that the the main folder has 4 contents.
1. Main project - heremapsusecaseapplication
2. Config file for the container - env.config
3. README.txt
4. Dockerfile

After unizipping the downloaded file, first we have to execute mvn clean and mvn install in the main project folder.

We have to use the Ubuntu OS for building and running the Docker usiing below steps.

Then we have to build the image by using the command below,
